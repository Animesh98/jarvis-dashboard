...
const VIEWABLE_EXTS = new Set([
  ...
  'txt', 'log', 'json', 'yml', 'yaml', 'toml', 'ini', 'conf', 'cfg', 'env',
  'py', 'js', 'jsx', 'ts', 'tsx', 'sh', 'bash', 'zsh', 'fish',
  'css', 'scss', 'sass', 'less', 'html', 'htm', 'xml', 'svg',
  'csv', 'tsv', 'sql', 'rs', 'go', 'java', 'c', 'cpp', 'h', 'hpp',
  'rb', 'php', 'lua', 'r', 'tex', 'gitignore', 'dockerfile', 'makefile',
]);
